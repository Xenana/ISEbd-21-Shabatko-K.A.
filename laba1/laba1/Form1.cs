...
namespace laba1
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAddOil_Click(object sender, EventArgs e)
        {
            if (!oil.State)
            {
                MessageBox.Show("Масла то нет, что добавлять?", "Ошибка логики", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            pan.InitOil();
            for (int i = 0; i < 3; ++i)
        ...
        private void buttonAddPotatos_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Картошку добавили, можно готовить", "Кухня", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void buttonCookPotatos_Click(object sender, EventArgs e)
        {
            ...
            if (stove.Pan.IsReady())
            {
                ...
                MessageBox.Show("Картошка пожарилась", "Кухня", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
        ...
        private void buttonGetPotatos_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Выкладываем чипсы на тарелку", "Кухня", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void buttonPutPotatos_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Чипсы готовы!", "Кухня", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
